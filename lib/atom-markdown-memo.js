...
export default {
  ...
  newFile() {
    ...
    atom.workspace.open(null).then((editor) => {
      ...
      body  = "---\n";
      body += "title: " + title + "\n";
      body += "created: " + now.format("YYYY/MM/DD HH:mm:ss") + "\n";
      body += "updated: " + now.format("YYYY/MM/DD HH:mm:ss") + "\n";
      body += "draft: true\n";
      body += "---\n";
  ...
  saveFile(){
    ...
    if (attr['updated']){
      editor.setText(
        text.replace(/^updated:\s*.*/m, "updated: " + moment().format("YYYY/MM/DD HH:mm:ss"))
      );
    }
  ...
  report(){
    ...
    atom.workspace.open(filepath).then((editor) => {
      ...
      if (text == ""){
        ...
        text += "created: " + now.format("YYYY/MM/DD HH:mm:ss") + "\n";
        text += "---\n";
      ...
      const header = "# " + now.format("YYYY-MM-DD HH:mm:ss");
      text += "\n"+header+"\n";
      editor.setText(text);
